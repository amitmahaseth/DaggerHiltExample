package com.example.daggerhiltdemo.adapter
...
import com.example.daggerhiltdemo.model.Cryptocurrency
import com.example.daggerhiltdemo.model.OnItemClicked

class CryptocurrencyAdapter(private val cryptocurrency: List<Cryptocurrency>, var onclick: OnItemClicked) : RecyclerView.Adapter<CryptocurrencyAdapter.ViewHolder>()  {
